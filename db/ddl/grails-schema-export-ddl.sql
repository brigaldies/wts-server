...
create table action_status_code (code varchar2(255 char) not null, version number(19,0) not null, date_created timestamp not null, description varchar2(4000 char), enabled number(1,0) default 1 not null, label varchar2(255 char) not null, primary key (code));
...
create table activity_type_code (code varchar2(255 char) not null, version number(19,0) not null, date_created timestamp not null, description varchar2(4000 char), enabled number(1,0) default 1 not null, label varchar2(255 char) not null, primary key (code));
...
create table asset_type_code (code varchar2(255 char) not null, version number(19,0) not null, date_created timestamp not null, description varchar2(4000 char), enabled number(1,0) default 1 not null, label varchar2(255 char) not null, primary key (code));
...
create table incident_status_code (code varchar2(255 char) not null, version number(19,0) not null, date_created timestamp not null, description varchar2(4000 char), enabled number(1,0) default 1 not null, label varchar2(255 char) not null, primary key (code));
...
create table person_asset_aff_type_code (code varchar2(255 char) not null, version number(19,0) not null, date_created timestamp not null, description varchar2(4000 char), enabled number(1,0) default 1 not null, label varchar2(255 char) not null, primary key (code));
...
create table threat_severity_code (code varchar2(255 char) not null, version number(19,0) not null, date_created timestamp not null, description varchar2(4000 char), enabled number(1,0) default 1 not null, label varchar2(255 char) not null, primary key (code));
create table threat_type_code (code varchar2(255 char) not null, version number(19,0) not null, date_created timestamp not null, description varchar2(4000 char), enabled number(1,0) default 1 not null, label varchar2(255 char) not null, primary key (code));
